...
#include <memory>
#include "../../CloudServer/mytcpsocket.h"
...
QT_MOC_LITERAL(1, 12, 9), // "clientOff"
...
void MyTcpSocket::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyTcpSocket::clientOff)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void MyTcpSocket::clientOff(MyTcpSocket * _t1)
{
