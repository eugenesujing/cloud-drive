...
#include <memory>
#include "../../CloudServer/mytcpserver.h"
...
QT_MOC_LITERAL(1, 12, 10), // "freeSocket"
QT_MOC_LITERAL(2, 23, 0), // ""
QT_MOC_LITERAL(3, 24, 12), // "MyTcpSocket*"
QT_MOC_LITERAL(4, 37, 8) // "mySocket"

    },
    "MyTcpServer\0freeSocket\0\0MyTcpSocket*\0"
    "mySocket"
};
...
void MyTcpServer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->freeSocket((*reinterpret_cast< MyTcpSocket*(*)>(_a[1]))); break;
        default: ;
        }
